...
class Save extends \Makarovsoft\Directaddto\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('makarovsoft_directaddto/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('makarovsoft_directaddto/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('makarovsoft_directaddto/*/new');
                }
                return;
            } catch (\Exception $e) {
